		...
		<article className={cls.root}>
			<header className={cls.common}>
				<div className={cls.commonOverlay}>
					...
					<p>Effective on September 19th, 2024</p>
				</div>
			</header>
			<main>
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						...
						<p>
							...
							you live). You represent that you are fully able and competent to enter into and comply with the terms and conditions in this TOS.
						</p>
					</div>
				</section>
				<section className={clsx(cls.padded)}>
				...
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						...
						<p>
							You retain all ownership rights in Your Data. However, you grant Volumetrics a worldwide, non-exclusive, royalty-free, sublicensable, and transferable license to use,
						...
						<p>
							You are solely responsible for your conduct, the content of Your Data, and all communications with others while using the Services. We are not responsible for the
							accuracy, appropriateness, or legality of Your Data or any other information you and your users may be able to access using the Services.
						</p>
					</div>
				</section>
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						...
						<p>You agree not to upload, post, transmit, or otherwise make available any content that:</p>
						<ul>
							<li>Infringes or violates any intellectual property rights, privacy rights, or other rights of any person or entity.</li>
							<li>Contains viruses, malware, or any other harmful code.</li>
							<li>
								Is unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, libelous, invasive of another's privacy, hateful, or racially, ethnically, or
				...
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						<h2 id="reps">Representations and Warranties</h2>
						<p>You represent and warrant to us that:</p>
						<ul>
							<li>You have full power and authority to enter into this TOS.</li>
							<li>
								You own all rights, title, and interest in Your Data or have obtained all necessary rights and permissions to use, share, and license Your Data as contemplated
								herein.
							</li>
							<li>
				...
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						<h2>Disclosure</h2>
						<p>
							You acknowledge, consent, and agree that we may access, preserve, and disclose your account information and Your Data if required to do so by law or in a good faith
							belief that such access, preservation, or disclosure is reasonably necessary to: (i) comply with legal process; (ii) enforce the TOS; (iii) respond to claims that any
							of Your Data violates the rights of third parties; (iv) respond to your requests for customer service; or (v) protect the rights, property, or personal safety of
							Volumetrics, its users, and the public.
						</p>
					</div>
				</section>
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						...
						<p>This TOS will continue in full effect unless and until your account or this TOS is terminated as described herein.</p>
						<p>
							We reserve the right to deactivate and delete your account or your content and terminate this TOS at any time for any reason, or no reason, with or without notice.
				...
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						...
						<p>
							...
							nuclear facilities, aircraft navigation/communication systems, air traffic control, and life support or weapons systems. The Services shall not be used for or in any
				...
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						...
						<p>
							UNDER NO CIRCUMSTANCES AND UNDER NO LEGAL THEORY (WHETHER IN CONTRACT, TORT, OR OTHERWISE) SHALL VOLUMETRICS BE LIABLE TO YOU OR ANY THIRD PARTY FOR (A) ANY INDIRECT,
							INCIDENTAL, SPECIAL, EXEMPLARY, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFITS, LOST SALES OR BUSINESS, LOST DATA, OR (B) FOR ANY AMOUNT IN THE AGGREGATE
							IN EXCESS OF THE FEES ACTUALLY PAID BY YOU IN THE SIX (6) MONTHS PRECEDING THE EVENT GIVING RISE TO YOUR CLAIM OR, IF NO FEES APPLY, FIVE HUNDRED ($500) U.S. DOLLARS,
							OR (C) ANY MATTER BEYOND OUR REASONABLE CONTROL. VOLUMETRICS SHALL NOT BE LIABLE FOR ANY CONTENT UPLOADED, POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE BY USERS
							OR THIRD PARTIES, INCLUDING ANY INFRINGEMENT OF THIRD-PARTY RIGHTS OR ANY ILLEGAL CONTENT.
						</p>
						<p>
							THE PROVISIONS OF THIS SECTION ALLOCATE THE RISKS UNDER THIS TOS BETWEEN THE PARTIES, AND THE PARTIES HAVE RELIED ON THESE LIMITATIONS IN DETERMINING WHETHER TO ENTER
							INTO THIS TOS.
						</p>
						<p>
							Some jurisdictions do not allow the exclusion of implied warranties or limitation of liability for incidental or consequential damages, which means that some of the
							above limitations may not apply to you. IN THESE JURISDICTIONS, OUR LIABILITY WILL BE LIMITED TO THE GREATEST EXTENT PERMITTED BY LAW.
						</p>
					</div>
				</section>
				<section className={clsx(cls.padded)}>
					<div className={cls.twoColumnsText}>
						...
						<p>
							We respect the intellectual property rights of others and expect our users to do the same. It is our policy to respond to clear notices of alleged copyright
							infringement that comply with the Digital Millennium Copyright Act ("DMCA") or other applicable intellectual property laws. In appropriate circumstances, we may
							terminate the accounts of users who are repeat infringers.
						</p>
						<p>
							If you believe that your work has been copied in a way that constitutes copyright infringement, or your intellectual property rights have been otherwise violated,
							please provide Volumetrics's Copyright Agent the following information:
						</p>
						<ol>
						...
						<p>
							Volumetrics's Agent for Notice of claims of copyright or other intellectual property infringement can be reached by email at{' '}
